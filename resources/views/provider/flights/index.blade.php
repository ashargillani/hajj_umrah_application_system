    ...
    <div class="panel-form">
        <div class="row">
            <div class="col-xs-12 col-sm-8">
                <h2><i class="fa fa-plane" aria-hidden="true"></i> &nbsp;Flights</h2>
                <label>Flights added uptill now</label>
                <hr />
            </div>
                            ...
                            @if(count($flights) >= 1)
                                @foreach($flights as $flight)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('flights.update', ['flight' => $flight]) }}">
                                                <button class="btn btn-info">Edit</button>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="{{ route('flights.destroy', ['flight' => $flight]) }}">
                            ...
                            @else
                                <tr>
                                    <td colspan="9" class="text-center">
                                        <h4 class="label-info">No Flights have been added uptill now !</h4>
                                    </td>
                                </tr>
                            @endif
                            </tbody>
