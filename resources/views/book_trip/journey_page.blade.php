...
@section('page-content')
    <div class="container-fluid margin-left-right-10">
        ...
        <div class="journey-page-form">
            <form>
                <fieldset>
                    <legend>Your Trip Details :</legend>
                    <div class="form-group row">
                        <div class="col-sm-4">Do you know the number of people travelling? Tick Yes or NO</div>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="noOfAdults" class="col-sm-4 col-form-label">Number of adults travelling</label>
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="noOfAdults" name="noOfAdults" placeholder="5">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-4">Are their any children travelling? Tick Yes or NO</div>
                        <div class="col-sm-8">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="childrenTravelling" id="childrenTravelling">
                    ...
                    <div class="form-group row">
                        <label for="childrenState" class="col-sm-4 col-form-label">Please choose from the list:</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label for="noOfPeople" class="col-sm-4 col-form-label">Number of people travelling in total</label>
                        <div class="col-sm-4">
                ...
                <fieldset>
                    ...
                    <div class="form-group row">
                        <label for="packageType" class="col-sm-4 col-form-label">Please choose from the list:</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label for="shiftingPackage" class="col-sm-4 col-form-label">Is this a shifting or non-shifting package ? Please choose from the list</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">Where would you like to go first ? Tick the checkbox</div>
                        <div class="col-sm-8">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="Makkah" name="firstRoute" id="firstRoute" />
                                <label class="form-check-label" for="firstRoute">
                                    Makkah
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="Medina" name="firstRoute" id="firstRoute">
                                <label class="form-check-label" for="firstRoute">
                                    Medina
                                </label>
                            </div>
                    ...
                    <div class="form-group row">
                        <label for="selectedRoute" class="col-sm-4 col-form-label">Preffered Route:</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label for="userExperience" class="col-sm-4 col-form-label">Is this your first time ?</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label for="visitDuration" class="col-sm-4 col-form-label">How long are you planning to stay ?</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label for="preferredBudget" class="col-sm-4 col-form-label">What is your budget ?</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label for="wheelchairAccessReason" class="col-sm-4 col-form-label">Do you or anyone require wheelchair access ?</label>
                        <div class="col-sm-4">
